Data engineering can be defined in many ways. Here are a few that all seem to say something slightly varied;
...
In summary, the common threads of the above translate to the following definition;
